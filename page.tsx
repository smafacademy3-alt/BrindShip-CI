      ...
      <div className="relative z-10 w-full min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 pt-28 pb-16 lg:pt-0">
          ...
          <div className="flex flex-wrap gap-4 mb-14">
            <a
              href="/register"
              className="group relative overflow-hidden bg-amber-400 hover:bg-amber-300 text-gray-900 font-black text-base px-8 py-4 rounded-2xl transition-all duration-300 shadow-2xl shadow-amber-500/40 hover:shadow-amber-400/60 hover:scale-105"
            >
